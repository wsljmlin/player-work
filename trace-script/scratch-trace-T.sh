...
init_cmds_loglevels() {
    ...
    setprop vendor.mediahal.loglevels 23
...
\t./scratch-trace-T.sh atrace/perfetto/log tunnel/vc/app/custom/cmd
\tatrace/perfetto/log: log will only scratch log, other will scratch trace & log"
    exit
}
